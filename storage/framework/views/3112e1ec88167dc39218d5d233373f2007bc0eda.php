                    ...
                    <div class="row">
                        ...
                        <div class="col form-group">
                            ...
                            <?php if(!empty($authPage->image)): ?>
                                <a href="<?php echo e(!empty($authPage->image) ? fetch_file($authPage->image,'upload/logo/') : '#'); ?>" target="_blank">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paulawit/malipos.co.ke/resources/views/auth_page/authPage.blade.php ENDPATH**/ ?>