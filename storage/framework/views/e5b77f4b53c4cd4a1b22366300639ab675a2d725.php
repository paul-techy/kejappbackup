            ...
            <div class="card table-card">
                <div class="card-header">
                    <div class="row align-items-center g-2">
                        <div class="col">
                            <h5><?php echo e(__('Type List')); ?></h5>
                        </div>
                        <?php if(Gate::check('create types')): ?>
                            <div class="col-auto">
                                <a class="btn btn-secondary customModal" href="#" data-size="md" data-url="<?php echo e(route('type.create')); ?>"
                                data-title="<?php echo e(__('Create Type')); ?>"> <i class="ti ti-circle-plus align-text-bottom"></i><?php echo e(__('Create Type')); ?></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paulawit/malipos.co.ke/resources/views/type/index.blade.php ENDPATH**/ ?>