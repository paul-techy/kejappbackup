                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <ul class="nav flex-column nav-tabs account-tabs mb-3" id="myTab" role="tablist">
                                ...
                                <?php if(Gate::check('manage twilio settings')): ?>
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo e(!empty($activeTab) && $activeTab == 'zettatel' ? ' active ' : ''); ?> "
                                            id="profile-tab-10" data-bs-toggle="tab" href="#zettatel" role="tab"
                                            aria-selected="false">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <i class="ti ti-message me-2 f-20"></i>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <h5 class="mb-0"><?php echo e(__('Zettatel SMS Settings')); ?></h5>
                                                    <small class="text-muted"><?php echo e(__('Zettatel SMS Settings')); ?></small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <div class="tab-content">
                                ...
                                <?php if(Gate::check('manage payment settings')): ?>
                                    <div class="tab-pane <?php echo e(!empty($activeTab) && $activeTab == 'payment_settings' ? ' active show ' : ''); ?>"
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-auto">
                                                <?php echo e(Form::label('mpesa_payment', __('M-Pesa Payment'), ['class' => 'form-label'])); ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="form-check custom-chek">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="mpesa_payment" id="mpesa_payment"
                                                            <?php echo e((!empty($settings['mpesa_payment']) && $settings['mpesa_payment'] == 'on') ? 'checked' : ''); ?>>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('mpesa_consumer_key', __('Consumer Key'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('mpesa_consumer_key', $settings['mpesa_consumer_key'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter M-Pesa consumer key')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('mpesa_consumer_secret', __('Consumer Secret'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('mpesa_consumer_secret', $settings['mpesa_consumer_secret'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter M-Pesa consumer secret')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('mpesa_passkey', __('Passkey'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('mpesa_passkey', $settings['mpesa_passkey'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter M-Pesa passkey')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('mpesa_business_shortcode', __('Business Short Code'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('mpesa_business_shortcode', $settings['mpesa_business_shortcode'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter business short code')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('mpesa_paybill_number', __('Paybill Number'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('mpesa_paybill_number', $settings['mpesa_paybill_number'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter paybill number')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('mpesa_environment', __('Environment'), ['class' => 'form-label me-2'])); ?>

                                                <div class="form-check custom-chek form-check-inline">
                                                    <input class="form-check-input" type="radio" value="sandbox"
                                                        id="mpesa_sandbox" name="mpesa_environment"
                                                        <?php echo e((!empty($settings['mpesa_environment']) && $settings['mpesa_environment'] == 'sandbox') ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="mpesa_sandbox"><?php echo e(__('Sandbox')); ?>

                                                    </label>
                                                </div>
                                                <div class="form-check custom-chek form-check-inline">
                                                    <input class="form-check-input" type="radio" value="production"
                                                        id="mpesa_production" name="mpesa_environment"
                                                        <?php echo e((!empty($settings['mpesa_environment']) && $settings['mpesa_environment'] == 'production') ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="mpesa_production"><?php echo e(__('Production')); ?>

                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <?php echo e(Form::label('mpesa_webhook_url', __('Webhook URL'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('mpesa_webhook_url', url('/api/mpesa/webhook'), ['class' => 'form-control', 'readonly' => true, 'placeholder' => __('Webhook URL')])); ?>

                                                <small class="text-muted"><?php echo e(__('Copy this URL and configure it in your M-Pesa account settings')); ?></small>
                                            </div>
                                        </div>
                                ...
                                <?php if(Gate::check('manage twilio settings')): ?>
                                    <div class="tab-pane <?php echo e(!empty($activeTab) && $activeTab == 'zettatel' ? ' active show ' : ''); ?>"
                                        id="zettatel" role="tabpanel" aria-labelledby="zettatel">

                                        <?php echo e(Form::model($settings, ['route' => ['setting.zettatel'], 'method' => 'post'])); ?>


                                        <div class="alert alert-info mb-3">
                                            <i class="ti ti-info-circle"></i>
                                            <strong><?php echo e(__('Note:')); ?></strong>
                                            <?php echo e(__('You can use either API Key or User ID/Password for authentication. API Key is preferred if available.')); ?>

                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <?php echo e(Form::label('zettatel_api_key', __('Zettatel API Key'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('zettatel_api_key', $settings['zettatel_api_key'], ['class' => 'form-control  mb-2', 'placeholder' => __('Enter API Key (Optional)')])); ?>

                                                <small class="form-text text-muted"><?php echo e(__('Optional: Use API Key for authentication instead of User ID/Password')); ?></small>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('zettatel_user_id', __('Zettatel User ID'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('zettatel_user_id', $settings['zettatel_user_id'], ['class' => 'form-control  mb-2', 'placeholder' => __('Enter User ID (Required if no API Key)')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('zettatel_password', __('Zettatel Password'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::password('zettatel_password', ['class' => 'form-control  mb-2', 'placeholder' => __('Enter Password (Required if no API Key)')])); ?>

                                                <small class="form-text text-muted"><?php echo e(__('Leave empty to keep existing password')); ?></small>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <?php echo e(Form::label('zettatel_sender_id', __('Zettatel Sender ID'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('zettatel_sender_id', $settings['zettatel_sender_id'], ['class' => 'form-control  mb-2', 'placeholder' => __('Enter Sender ID (Required)')])); ?>

                                                <small class="form-text text-muted"><?php echo e(__('Your registered and approved sender name')); ?></small>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-6"></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\kejappbackup\resources\views/settings/index.blade.php ENDPATH**/ ?>