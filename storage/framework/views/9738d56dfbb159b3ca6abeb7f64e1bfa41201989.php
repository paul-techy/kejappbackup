...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group">
            ...
            <?php echo Form::select('interval', $intervals, null,array('class' => 'form-control basic-select','required'=>'required')); ?>
        ...
        <div class="form-group col-md-6">
            <div class="form-check form-switch custom-switch-v1 mb-2">
                <input type="checkbox" class="form-check-input input-secondary" name="is_trial" id="is_trial">
...
<?php /**PATH C:\wamp64\www\kejappbackup\resources\views/subscription/create.blade.php ENDPATH**/ ?>