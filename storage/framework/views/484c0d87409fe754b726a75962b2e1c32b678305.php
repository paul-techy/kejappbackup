...
<script>
    var lightLogo = "<?php echo e(!empty($lightLogo) ? fetch_file($lightLogo, 'upload/logo/') : '#'); ?>";
...
<script>
    $(document).on('click', ".copy_link", function() {
        ...
        toastrs('Success', '<?php echo __('Link has been copied to the clipboard.'); ?>', 'success')
    });
</script>
<script>
...
<?php endif; ?>
<?php /**PATH /home/paulawit/malipos.co.ke/resources/views/admin/footer.blade.php ENDPATH**/ ?>