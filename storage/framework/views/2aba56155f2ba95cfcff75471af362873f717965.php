    ...
    <div class="row wow fadeInUp">
        <div class="col-xl-12">
            <div class="position-relative">
                ...
                <?php echo e(Form::open(['route' => ['search.filter', 'code' => $user->code], 'method' => 'GET', 'id' => 'package_filter'])); ?>
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="bselect-style1">
                                <label for="country" class="form-label"><?php echo e(__('Select Country')); ?></label>
                        ...
                        <div class="col-md-3">
                            <div class="bselect-style1">
                                <label for="state" class="form-label"><?php echo e(__('Select State')); ?></label>
                        ...
                        <div class="col-md-3">
                            <div class="bselect-style1">
                                <label for="city" class="form-label"><?php echo e(__('Select City')); ?></label>
                         ...
                         <div class="col-md-1">
                           ...
                           <a href="<?php echo e(route('search.filter', ['code' => $user->code])); ?>"
                            class="ud-btn btn-thm3 w-100 d-flex align-items-center justify-content-center" id="reset_button">
                                <i class="fas fa-rotate-left me-1"></i> <?php echo e(__('Reset')); ?>
            ...
            <div class="wow fadeInUp" data-wow-delay="300ms">
                <div class="row mb20">
                    <div class="text-center">
                        <p class="h4"><?php echo e(__('Find Your Perfect Property')); ?></p>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#country').on('change', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('get-states', $user->code)); ?>",
                    type: 'GET',
            ...
            $('#state').on('change', function () {
                ...
                $.ajax({
                     url: "<?php echo e(route('get-cities', $user->code)); ?>",
                    type: 'GET',
                    data: { state: state },
                    success: function (res) {
...
<?php echo $__env->make('theme.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paulawit/malipos.co.ke/resources/views/theme/property.blade.php ENDPATH**/ ?>