    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <div class="form-check form-switch custom-switch-v1 mb-2">
                <input type="checkbox" class="form-check-input input-secondary" name="is_trial" id="is_trial" <?php echo e($subscription->is_trial==1?'checked':''); ?>>
                <?php echo e(Form::label('is_trial',__('Lifetime Free Package'),array('class'=>'form-label'))); ?>
        ...
        <div class="form-group col-md-6">
            <div class="form-check form-switch custom-switch-v1 mb-2">
                <input type="checkbox" class="form-check-input input-secondary" name="enabled_logged_history" id="enabled_logged_history" <?php echo e($subscription->enabled_logged_history==1?'checked':''); ?>>
...
<?php /**PATH C:\wamp64\www\kejappbackup\resources\views/subscription/edit.blade.php ENDPATH**/ ?>