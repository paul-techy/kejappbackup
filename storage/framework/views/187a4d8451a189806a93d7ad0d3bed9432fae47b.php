...
<head>
    ...
    <meta property="twitter:image"
        content="<?php echo e(!empty($settings['meta_seo_image']) ? fetch_file($settings['meta_seo_image'], 'upload/logo/') : '#'); ?>">

    <link rel="icon"
        href="<?php echo e(!empty($settings['company_favicon']) ? fetch_file($settings['company_favicon'], 'upload/logo/') : '#'); ?>"
        type="image/x-icon" />
...
<body
    ...
    <div class="auth-main">
        <div class="auth-wrapper v2">
            <div class="auth-form">
                <div class="logo">
                    <a class="navbar-brand landing-logo" href="<?php echo e(route('home')); ?>"><img
                            src="<?php echo e(!empty($settings['logo']) ? fetch_file($settings['logo'], 'upload/logo/') : '#'); ?>"
...
<?php /**PATH /home/paulawit/malipos.co.ke/resources/views/layouts/auth.blade.php ENDPATH**/ ?>