                ...
                <div class="card-header">
                    <div class="row align-items-center g-2">
                        ...
                        <div class="col-auto d-flex gap-2">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage tenant')): ?>
                                <a class="btn btn-primary" href="<?php echo e(route('tenant.send-sms')); ?>" data-size="md"> <i
                                        class="ti ti-message align-text-bottom"></i> <?php echo e(__('Send SMS')); ?></a>
                            <?php endif; ?>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                <div class="card follower-card">
                                    <div class="card-body p-3">
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="flex-grow-1 ms-3 mx-2">
                                                <img class="img-fluid wid-70"
                                                    src = "<?php echo e(!empty($tenant->user->profile) ? fetch_file($tenant->user->profile, 'upload/profile/') : $profile); ?>"
                                                    alt="Image">
                                            </div>
                                        ...
                                        <a href="<?php echo e(route('tenant.show', \Crypt::encrypt($tenant->id))); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\kejappbackup\resources\views/tenant/index.blade.php ENDPATH**/ ?>