            ...
            <ul class="list-unstyled">
                <?php if(\Auth::user()->type == 'owner'): ?>
                    <li class="dropdown pc-h-item">
                        <a href="#"
                            ...
                            data-url="<?php echo e(route('web.page', \Auth::user()->code)); ?>" data-bs-placement="bottom"
                            data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Click to Copy')); ?>"><i
                                class="ti ti-copy fs-15"></i>
                        </a>
                    </li>
                <?php endif; ?>

                <li class="dropdown pc-h-item" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Language')); ?>"
                ...
                <li class="dropdown pc-h-item header-user-profile">
                    <a class="pc-head-link head-link-primary dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown"
                        ...
                        <img src="<?php echo e(!empty($users->profile) ? fetch_file($users->profile, 'upload/profile/') : $profile); ?>"
...
<?php /**PATH /home/paulawit/malipos.co.ke/resources/views/admin/header.blade.php ENDPATH**/ ?>