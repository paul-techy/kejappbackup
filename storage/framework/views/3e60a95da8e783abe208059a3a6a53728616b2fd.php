...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('rent_type',$rentTypes,null,array('class'=>'form-control basic-select','id'=>'rent_type'))); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('deposit_type',$types,null,array('class'=>'form-control basic-select'))); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('late_fee_type',$types,null,array('class'=>'form-control basic-select'))); ?>
...
<?php /**PATH /home/paulawit/malipos.co.ke/resources/views/unit/edit.blade.php ENDPATH**/ ?>