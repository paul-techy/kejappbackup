<?php
    ...
    $default_landing_logo = Storage::url('upload/logo/landing_logo.png');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta property="og:image" content="<?php echo e(!empty($settings['meta_seo_image']) ? fetch_file($settings['meta_seo_image'],'upload/seo/') : '#'); ?>">
    ...
    <meta property="twitter:image"
        content="<?php echo e(!empty($settings['meta_seo_image']) ? fetch_file($settings['meta_seo_image'],'upload/seo/') : '#'); ?>">


    <link rel="icon" href="<?php echo e(!empty($settings['company_favicon']) ? fetch_file($settings['company_favicon'],'upload/logo/') : '#'); ?>"
        type="image/x-icon" />
    ...
    <nav class="navbar navbar-expand-md navbar-light default">
        <div class="container">
            <a class="navbar-brand landing-logo" href="#">
                <img src="<?php echo e(!empty($settings['landing_logo']) ? fetch_file($settings['landing_logo'],'upload/logo/') : $default_landing_logo); ?>" alt="logo"
                    class="img-fluid " />
            </a>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <?php else: ?>
                                <?php echo e(__('Smart Tenant - Property Management System')); ?>
                        ...
                        <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <?php else: ?>
                                <?php echo e(__('Property management refers to the administration, operation, and oversight of real estate properties on behalf of property owners. It involves various tasks such as marketing rental properties, finding tenants, collecting rent and ensuring legal compliance.')); ?>
                        ...
                        <div class="mb-4 mb-lg-0 d-inline-flex align-items-center wow fadeInUp" data-wow-delay="0.8s">
                            <div class="flex-shrink-0">
                                <div class="avtar avtar-l bg-light-secondary text-secondary">
                                    ...
                                    <?php else: ?>
                                        <img src="<?php echo e(asset(Storage::url('upload/homepage/banner_2.png'))); ?>"
                                            alt="user-image" class="img-fluid wid-80" />
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-0 text-start">
                                    ...
                                    <?php else: ?>
                                        <?php echo e(__('Manage your business efficiently with our all-in-one solution designed for
                    ...
                    <div class="col-lg-6">
                        <div class="hero-image">
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(Storage::url('upload/homepage/banner_1.png')); ?>" alt="user-image"
                                    class="img-fluid" />
                            <?php endif; ?>
                        </div>
                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="avtar avtar-l">
                                            <img src="<?php echo e(!empty($Section_2_content_value['box_image_1_path']) ? asset(Storage::url($Section_2_content_value['box_image_1_path'])) : Storage::url('upload/homepage/OverView_1.svg')); ?>"
                        ...
                        <div class="card feature-card mb-0 bg-blue-200">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="avtar avtar-l">
                                            <img src="<?php echo e(!empty($Section_2_content_value['box_image_2_path']) ? asset(Storage::url($Section_2_content_value['box_image_2_path'])) : Storage::url('upload/homepage/OverView_2.svg')); ?>"
                                                alt="img" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 ms-3 text-end">
                        ...
                        <div class="card feature-card mb-0 bg-purple-200">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="avtar avtar-l">
                                            <img src="<?php echo e(!empty($Section_2_content_value['box_image_3_path']) ? asset(Storage::url($Section_2_content_value['box_image_3_path'])) : Storage::url('upload/homepage/OverView_3.svg')); ?>"
                                                alt="img" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 ms-3 text-end">
                    ...
                    <div class="row align-items-center g-4">
                        <?php if($is3 % 2 != 0): ?>
                            <div class="col-md-6 text-center mb-md-5">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(storage_path('upload/homepage/img-customize-1.svg')); ?>"
                                        alt="img" class="img-fluid w-75" />
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="col-md-6 text-center mb-md-5">
                                ...
                                <?php if(!empty($Section_3_content_value['Box' . $is3 . '_image_path'])): ?>
                                    <img src="<?php echo e(asset(Storage::url($Section_3_content_value['Box' . $is3 . '_image_path']))); ?>"
                                        alt="img" class="img-fluid w-75" />
                                <?php else: ?>
                                    <img src="<?php echo e(Storage::url('upload/homepage/img-customize-2.svg')); ?>"
                                        alt="img" class="img-fluid w-75" />
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                ...
                <div class="row g-4 text-center">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <?php if(!empty($Section_4_content_value['Sec4_box' . $is4 . '_image_path'])): ?>
                                    <img src="<?php echo e(asset(Storage::url($Section_4_content_value['Sec4_box' . $is4 . '_image_path']))); ?>"
                                        alt="img" class="img-fluid" />
                                <?php else: ?>
                                    <img src="<?php echo e(Storage::url('upload/homepage/offers_1.svg')); ?>" alt="img"
                                        class="img-fluid" />
                                <?php endif; ?>
                    ...
                    <?php if($is4_check == 0): ?>
                        <div class="col-md-6 col-xl-4">
                            <img src="<?php echo e(Storage::url('upload/homepage/offers_1.svg')); ?>" alt="img"
                                class="img-fluid" />
                            <h3 class="my-4 fw-semibold"><?php echo e(__('User-Friendly Interface')); ?></h3>
                            <p>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <img src="<?php echo e(Storage::url('upload/homepage/offers_2.svg')); ?>" alt="img"
                                class="img-fluid" />
                            <h3 class="my-4 fw-semibold"><?php echo e(__('End-to-End Automation')); ?></h3>
                            <p>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <img src="<?php echo e(Storage::url('upload/homepage/offers_3.svg')); ?>" alt="img"
                                class="img-fluid" />
                            <h3 class="my-4 fw-semibold"><?php echo e(__('Customizable Solutions')); ?></h3>
                            <p>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <img src="<?php echo e(Storage::url('upload/homepage/offers_4.svg')); ?>" alt="img"
                                class="img-fluid" />
                            <h3 class="my-4 fw-semibold"><?php echo e(__('Scalable Features')); ?></h3>
                            <p>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <img src="<?php echo e(Storage::url('upload/homepage/offers_5.svg')); ?>" alt="img"
                                class="img-fluid" />
                            <h3 class="my-4 fw-semibold"><?php echo e(__('Enhanced Security')); ?></h3>
                            <p>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <img src="<?php echo e(Storage::url('upload/homepage/offers_6.svg')); ?>" alt="img"
                                class="img-fluid" />
                            <h3 class="my-4 fw-semibold"><?php echo e(__('Real-Time Analytics')); ?></h3>
                            <p>
                ...
                <div class="container">
                    ...
                    <div class="row text-center justify-content-center">
                        ...
                        <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6 col-lg-4">
                                <div class="card price-card <?php echo e($subscription->is_trial ? 'border-success' : ''); ?>">
                                    <div class="card-body">
                                        <h2 class=""><?php echo e($subscription->title); ?></h2>
                                        <?php if($subscription->is_trial): ?>
                                            <span class="badge bg-success mb-2"><?php echo e(__('Free Forever')); ?></span>
                                        <?php endif; ?>
                                        <div class="price-price mt-4">
                                            <?php if($subscription->is_trial): ?>
                                                <span class="h1 text-success"><?php echo e(__('Free')); ?></span>
                                                <span class="text-muted">/<?php echo e($subscription->interval); ?></span>
                                            <?php else: ?>
                                        ...
                                        <?php if($subscription->is_trial): ?>
                                            <a class="btn btn-success text-white mt-4"
                                                href="<?php echo e(route('register')); ?>"
                                                role="button">
                                                <?php echo e(__('Start Free Forever')); ?>

                                            </a>
                                            <?php if(isset($cheapestPaidSubscription) && $cheapestPaidSubscription): ?>
                                                <p class="text-muted small mt-2 mb-0">
                                                    <?php echo e(__('Upgrade anytime for more features')); ?>
                            ...
                            <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <?php if(!empty($Section_6_content_value['Sec6_box' . $s6_key . '_image_path'])): ?>
                                                <img src="<?php echo e(asset(Storage::url($Section_6_content_value['Sec6_box' . $s6_key . '_image_path']))); ?>"
                                                    alt="img" class="img-fluid" />
                                            <?php else: ?>
                                                <img src="<?php echo e(Storage::url('upload/homepage/1.png')); ?>"
                                ...
                                <?php else: ?>
                                    <div class="swiper-slide">
                                        ...
                                        <p><?php echo e(__(' Property management refers to the administration, operation, and oversight of real estate properties on behalf of property owners. ')); ?>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <div class="flex-shrink-0">
                                        <div class="avtar avtar-l">
                                            ...
                                            <?php else: ?>
                                                <img src="<?php echo e(Storage::url('upload/homepage/review_1.png')); ?>"
                                                    alt="img" class="img-fluid rounded-circle wid-40" />
                                            <?php endif; ?>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 d-none d-md-block">
                        <img src="<?php echo e(Storage::url('upload/homepage/img-bg-hand.png')); ?>" alt="img"
                            ...
                            <?php else: ?>
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body text-muted">
                                            <?php echo e(__('Our software provides a range of features including automation tools,
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body text-muted">
                                            <?php echo e(__('Yes! Our platform is designed to be user-friendly and intuitive, so your
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body text-muted">
                                            <?php echo e(__('Absolutely! Our software is built to easily integrate with your current
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapse-four" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body text-muted">
                                            <?php echo e(__('Yes! We offer 24/7 customer support. Our dedicated team is ready to assist
                ...
                <div class="row">
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4 class="my-3 text-white">
                            <?php echo e(!empty($Section_10_content_value['Sec10_title']) ? $Section_10_content_value['Sec10_title'] : 'About Law Practice SaaS'); ?>
...
<?php /**PATH C:\wamp64\www\kejappbackup\resources\views/layouts/landing.blade.php ENDPATH**/ ?>