                                        ...
                                        <th>
                                            <div class="card-body border-start text-center py-5 py-md-5">
                                                ...
                                                <?php if($subscription->is_trial): ?>
                                                    <span class="badge bg-success mb-2"><?php echo e(__('Free Trial')); ?></span>
                                                <?php endif; ?>
                                                    ...
                                                    <div class="border-start py-4 py-md-5">
                                                        <?php if($subscription->is_trial): ?>
                                                            <a href="<?php echo e(route('subscriptions.start.trial', \Illuminate\Support\Facades\Crypt::encrypt($subscription->id))); ?>"
                                                                class="btn btn-success bg-success text-white"
                                                                onclick="return confirm('<?php echo e(__('Are you sure you want to start the free package?')); ?>')">
                                                                <?php echo e(__('Start Free Forever')); ?>

                                                            </a>
                                                        <?php elseif($subscription->package_amount > 0): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\kejappbackup\resources\views/subscription/index.blade.php ENDPATH**/ ?>