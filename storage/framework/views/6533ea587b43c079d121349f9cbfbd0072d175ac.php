                                            ...
                                            <td>
                                                <div class="cart-action">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit invoice')): ?>
                                                        <a class="avtar avtar-xs btn-link-secondary text-secondary" data-bs-original-title="<?php echo e(__('Edit')); ?>"
                                                            href="<?php echo e(route('invoice.edit',\Crypt::encrypt($invoice->id))); ?>" data-bs-toggle="tooltip"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paulawit/malipos.co.ke/resources/views/invoice/index.blade.php ENDPATH**/ ?>