                                        ...
                                        <td>
                                            <?php if($transaction->payment_type == 'Stripe'): ?>
                                                <a class="text-primary" data-bs-toggle="tooltip" target="_blank"
                                                    ...
                                                    href="<?php echo e($transaction->receipt); ?>">
                                            ...
                                            <?php elseif($transaction->payment_type == 'Bank Transfer'): ?>
                                                ...
                                                <a class="text-primary" data-bs-toggle="tooltip" target="_blank"
                                                    data-bs-original-title="<?php echo e(__('Receipt')); ?>"
                                                    href="<?php echo e(!empty($transaction->receipt) ? fetch_file($transaction->receipt, 'upload/receipt/') : '#'); ?>">
                                                    <i data-feather="file"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paulawit/malipos.co.ke/resources/views/subscription/transaction.blade.php ENDPATH**/ ?>