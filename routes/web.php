...
Route::group(
    ...
    function () {
        ...
        Route::get('subscriptions/{id}/start-trial', [SubscriptionController::class, 'startTrial'])->name('subscriptions.start.trial');
        Route::get('subscriptions/{id}/upgrade', [SubscriptionController::class, 'upgrade'])->name('subscriptions.upgrade');
...
Route::group(
    ...
    function () {
        ...
        Route::post('settings/zettatel', [SettingController::class, 'zettatel'])->name('setting.zettatel');
    }
);
...
// Tenant SMS routes
Route::get('tenant/send-sms', [TenantController::class, 'showSendSms'])->name('tenant.send-sms')->middleware(['auth', 'XSS']);
Route::post('tenant/send-sms', [TenantController::class, 'sendSms'])->name('tenant.send-sms.post')->middleware(['auth', 'XSS']);
Route::post('tenant/send-sms-all', [TenantController::class, 'sendSmsToAll'])->name('tenant.send-sms-all')->middleware(['auth', 'XSS']);
