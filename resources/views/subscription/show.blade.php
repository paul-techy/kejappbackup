...
@section('content')
    @php
        ...
        $isOnFreePackage = $currentSubscription && $currentSubscription->is_trial;
    @endphp
    
    @if ($isOnFreePackage && !$subscription->is_trial)
        <div class="row">
            <div class="col-12">
                <div class="alert alert-info">
                    <h5 class="mb-2">{{ __('Upgrade to Premium') }}</h5>
                    <p>{{ __('You are currently on the free package. Upgrade now to unlock more features and capabilities!') }}</p>
                </div>
            </div>
        </div>
    @endif
                                ...
                                <tr>
                                    <td>
                                        ...
                                        @if ($subscription->is_trial)
                                            <span class="badge bg-success ms-2">{{ __('Free Trial') }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        <b class="discoutedPrice">
                                            @if ($subscription->is_trial)
                                                {{ __('Free') }}
                                            @else
                                                {{ subscriptionPaymentSettings()['CURRENCY_SYMBOL'] }}{{ $subscription->package_amount }}
                                            @endif
                                        </b>
                                    </td>
            ...
            <div class="col-lg-12">
                @if ($subscription->is_trial)
                    <div class="alert alert-success mb-4">
                        <h5 class="mb-2">{{ __('Lifetime Free Package') }}</h5>
                        <p>{{ __('This is a free package that never expires. Start using it now and upgrade anytime to unlock premium features!') }}</p>
                        <a href="{{ route('subscriptions.start.trial', \Illuminate\Support\Facades\Crypt::encrypt($subscription->id)) }}"
                            class="btn btn-success"
                            onclick="return confirm('{{ __('Are you sure you want to start the free package?') }}')">
                ...
                <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="d-inline">{{ __('Bank Transfer Payment') }}</h5>
                                    @if ($subscription->couponCheck() > 0)
                    ...
                    @if ($settings['STRIPE_PAYMENT'] == 'on' && !empty($settings['STRIPE_KEY']) && !empty($settings['STRIPE_SECRET']))
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="d-inline">{{ __('Stripe Payment') }}</h5>
                                    @if ($subscription->couponCheck() > 0)
                                        <div class="setting-card action-menu float-end">
                                            <div class="form-group mb-0">
                                                <div class="form-check custom-chek">
                    ...
                    @if (
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="d-inline">{{ __('Flutterwave Payment') }}</h5>
                                    @if ($subscription->couponCheck() > 0)
                                        <div class="setting-card action-menu float-end">
                                            <div class="form-group mb-0">
                                                <div class="form-check custom-chek">
                    ...
                    @if (
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="d-inline">{{ __('Paypal Payment') }}</h5>
                                    @if ($subscription->couponCheck() > 0)
                                        <div class="setting-card action-menu float-end">
                                            <div class="form-group mb-0">
                                                <div class="form-check custom-chek">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body profile-user-box">
                                <form class="require-validation" method="POST" id="paystack-payment-form" action="{{ route('subscription.pay.with.paystack') }}">
                                    @csrf
