    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <div class="form-check form-switch custom-switch-v1 mb-2">
                <input type="checkbox" class="form-check-input input-secondary" name="is_trial" id="is_trial" {{$subscription->is_trial==1?'checked':''}}>
                {{Form::label('is_trial',__('Lifetime Free Package'),array('class'=>'form-label'))}}
            </div>
        </div>
        <div class="form-group">
