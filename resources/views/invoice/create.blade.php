                ...
                <div class="card-body">
                    <div class="info-group">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-lg-4">
                                {{ Form::label('invoice_type', __('Invoice Type'), ['class' => 'form-label']) }}
                                <div class="form-check form-check-inline">
                                    {{ Form::radio('invoice_type', 'one_time', true, ['class' => 'form-check-input', 'id' => 'invoice_type_one_time']) }}
                                    {{ Form::label('invoice_type_one_time', __('One-time'), ['class' => 'form-check-label']) }}
                                </div>
                                <div class="form-check form-check-inline">
                                    {{ Form::radio('invoice_type', 'recurring', false, ['class' => 'form-check-input', 'id' => 'invoice_type_recurring']) }}
                                    {{ Form::label('invoice_type_recurring', __('Recurring'), ['class' => 'form-check-label']) }}
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-lg-4 recurring-options" style="display: none;">
                                {{ Form::label('recurring_interval', __('Recurring Interval'), ['class' => 'form-label']) }}
                                {{ Form::select('recurring_interval', [
                                    'daily' => __('Daily'),
                                    'monthly' => __('Monthly'),
                                    'yearly' => __('Yearly')
                            ...
                            <div class="form-group col-md-6 col-lg-4 recurring-options" style="display: none;">
                                {{ Form::label('recurring_end_date', __('Recurring End Date (Optional)'), ['class' => 'form-label']) }}
                                {{ Form::date('recurring_end_date', null, ['class' => 'form-control', 'id' => 'recurring_end_date']) }}
                                <small class="form-text text-muted">{{ __('Leave empty for unlimited recurring') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
